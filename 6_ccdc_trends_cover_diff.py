...
def allCalc(inTrends, inCCDC, OutDir, FromY, ToY):
    ...
    try:
        ...
        if FileFormat == 'GTiff':
            ...
            if not os.path.exists(bandFile):
                ...
                print
                "%s was already processed" % (os.path.basename(bandFile))
        else:
            print
            "use 'GTiff' for file format"
            sys.exit(1)

    except:
        print
        "Dang!! Something terrible happened"
        print
