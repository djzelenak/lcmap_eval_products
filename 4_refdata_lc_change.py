...
def get_inlayers(infolder, name, y1, y2):
    ...
    Returns:
        ...
        infile1 <string> path to the year1 input NLCD
        
        infile2 <string> path to the year2 input NLCD
    ...
    # flist = [r for y in yearlist for r in filelist if str(y) in r]
...
def usage():
    ...
    print("\t[-i Full path to the directory where reference LC data "\
              "map layers are saved]\n" \
     "\t[-from The start year]\n" \
     "\t[-to The end year]\n" \
